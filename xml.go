...
func main() {
	...
	parse(buildXmlStructs(xsd), os.Stdout)
}
...
func buildXmlStructs(schemas []xsdSchema) []*xmlElem {
	var roots []element
...
func parse(roots []*xmlElem, out io.Writer) {
	fmt.Fprintf(out, "// Generated content, do not edit this file directly.\n\npackage main\n\n\n")
	for _, e := range roots {
		doParse(e, out)
	}
}
